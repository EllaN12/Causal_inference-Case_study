...
def data_preprocessing():
    ...
    df = pd.concat([numerical_data_df, cat_data_df], axis=1)

    # add additional features
    
    # patrons cuisine preference vs restautant cuisine specialty
    ...
    # Restaurant Clusters Feature based on geolocation  
