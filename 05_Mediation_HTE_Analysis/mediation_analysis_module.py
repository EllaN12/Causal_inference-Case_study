...
import os
from .causal_graph_module_complete import define_causal_graph_custom, correlation_edges
...
def run_mediation_analysis(df, treatments, outcome='rating', graph=None, 
                          save_chart=True, chart_path= os.path.abspath(os.path.join('Reports', 'treatment_attribution.png'))):
    """
...
if __name__ == "__main__":
    analyzer, summary_df = run_mediation_analysis(
        ...
        outcome='rating',
        save_chart=True,
        chart_path='example_attribution.png'
    )
